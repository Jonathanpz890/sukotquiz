            ...
            content = (
                <div className='open-screen'>
                    ...
                    <div className='text'>
                        ...
                        <h1><span>מזמינים אתכם</span><span>לסוכה</span></h1> 
                        <p>
                        רוצים לפנק את החברים לפלוגה?<br></br>
                         יודעים מהם ארבעת המינים?<br></br>
                          ענו נכונה על כמה שיותר שאלות לפני שנגמר הזמן, ואולי תזכו בשובר לערכת קפה מפנקת בשווי 100 ש״ח מתנת כוורת און-ליין<br></br>
מוכנים? 
                        </p>
                    </div>
                    <button onClick={this.startForm}>להתחלת המשחק</button>
                </div>
            )
